...
function Card() {
    return (
        <div className='flex justify-center items-center flex-col m-auto '>
            <div className='flex gap-[40px] mt-4 items-center'>
                <a className='text-[#696671] text-[20px] font-medium ' href="#">Study</a>
                <a className='text-[#696671] text-[20px] font-medium' href="#">Quiz</a>
                <a className='text-[#696671] text-[20px] font-medium' href="#">Test</a>
                <a className='text-[#696671] text-[20px] font-medium' href="#">Game</a>
                <a className='text-[#696671] text-[20px] font-medium' href="#">Others</a>
            ...
            <div className="inline-flex flex-col items-center gap-8">
                ...
                <div className='flex gap-[140px] items-center'>
                    ...
                    <svg className='w-[30px] h-[30.019px]' xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
                    ...
                    <div className="flex items-center gap-[43px]">
                        <svg className='w-[60px] h-[60px]' xmlns="http://www.w3.org/2000/svg" width="60" height="61" viewBox="0 0 60 61" fill="none">
                        ...
                        <span className='leading-trim text-edge-cap font-inter
                     text-2xl font-bold'>01/10</span>
                    ...
                    <svg className='w-[30px] h-[30px]' xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
